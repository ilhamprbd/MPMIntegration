...
public class GenerateDocsRepository
{
    ...
    public async Task<string> RenderReportSertifikatAsync(int intReportCode, string strExportFormat, string strPath, List<it_report_list> lReportlist, string strBatchid)
    {
        try
        {
            ...
            // Save report to file
            string strFilename = $"{"cerno"}{strBatchid}-{DateTime.Now:yyyyMMddhhmmss}";
